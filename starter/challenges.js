...
document.querySelector('.btn-roll').addEventListener('click', function () {
    if (gamePlaying) {
        ...
        if ((dice1 === 6 && lastRoll === 6) || ((dice2 === 6 && lastRoll2 === 6))) {
            //player loses score
            scores[activePlayer] = 0;
            document.querySelector('#score-' + activePlayer).textContent = 0;
            console.log('2 6\'s in a row were rolled!');
            nextPlayer();
...
function nextPlayer() {
    ...
    //Hiding the dice after a 1 is rolled and until the next player takes their turn
